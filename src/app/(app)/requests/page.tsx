...
import { getRequestTypeLabel, getRequestTypes, PARTY_FORMAT_LABELS, SHOW_REQUEST_CLASSIFICATION, VENUE_TYPE_LABELS } from '@/lib/utils';
...
export default function RequestsPage() {
  ...
  if (role === 'manager') {
    ...
    const filtered = openRequests.filter((r) => !typeFilter || getRequestTypes(r).includes(typeFilter));
    return (
