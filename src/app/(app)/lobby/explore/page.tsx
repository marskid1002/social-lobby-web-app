...
function FemaleTile({ userId, blurred }: { userId: string; blurred?: boolean }) {
  ...
  if (blurred) {
    return (
      <div className="w-full max-w-[140px] overflow-hidden rounded-xl bg-white shadow-sm ring-1 ring-black/5 select-none pointer-events-none [@media(min-height:700px)]:max-w-[155px]">
  ...
  return (
    <article className="group w-full max-w-[140px] overflow-hidden rounded-xl bg-white shadow-sm ring-1 ring-black/5 [@media(min-height:700px)]:max-w-[155px]">
      <div className="relative aspect-[7/6] overflow-hidden bg-zinc-100 [@media(min-height:700px)]:aspect-[4/5]">
        <img
